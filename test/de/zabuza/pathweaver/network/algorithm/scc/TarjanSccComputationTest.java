...
public final class TarjanSccComputationTest {
	...
	public void testGetLargestScc() {
		...
		final TarjanSccComputation computation = new TarjanSccComputation(network);
	...
	public void testGetPathNetwork() {
		...
		final TarjanSccComputation anotherComputation = new TarjanSccComputation(anotherNetwork);
